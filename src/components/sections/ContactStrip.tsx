            ...
            <div className="flex flex-wrap" style={{ gap: "1rem" }}>
                ...
                <a
                    ...
                    style={{
                        ...
                        background: waHovered ? "var(--gold)" : "transparent",
                        color: waHovered ? "var(--black)" : "var(--gold)",
                ...
                <a
                    ...
                    style={{
                        ...
                        color: contactHovered ? "var(--black)" : "var(--gold)",
                        background: contactHovered ? "var(--gold)" : "transparent",
                        fontFamily: "'Cinzel', serif",
                        fontSize: "11px",
                        letterSpacing: "0.15em",
                        textDecoration: "none",
